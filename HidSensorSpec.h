...
#define HID_USAGE_SENSOR_EVENT_HIGH_THESHOLD_CROSS_ABOVE  HID_USAGE_SENSOR_EVENT_HIGH_THRESHOLD_CROSS_UPWARD
...
#define HID_USAGE_REPORTING_STATE_ON_ALL  HID_USAGE_SENSOR_PROPERTY_REPORTING_STATE_ALL_EVENTS
#define HID_USAGE_SENSOR_PROPERTY_REPORTING_STATE_THRESHOLD_EVENTS  0x0A,0x42,0x08 // Sel
#define HID_USAGE_REPORTING_STATE_ON_THRESHOLD  HID_USAGE_SENSOR_PROPERTY_REPORTING_STATE_THRESHOLD_EVENTS
...
/* programmer aids for generating array values in feature reports */

#define HID_SENSOR_VALUE_SIZE_8(x)  (uint8_t)(x)
